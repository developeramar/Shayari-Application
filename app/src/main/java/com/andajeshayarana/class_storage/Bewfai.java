...
public class Bewfai extends AppCompatActivity implements View.OnClickListener {

    ImageButton btn_previous,btn_next,btn_copy,btn_share;
    TextView shayari_text,shayari_text2,count_txt;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference("Bewfai");
